...
impl From<crate::R<SCGC_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<SCGC_SPEC>> for W {
    #[inline(always)]
...
#[doc = "Field `PWT` reader - PWT Clock Gate Control"]
pub struct PWT_R(crate::FieldReader<bool, PWT_A>);
impl PWT_R {
    pub(crate) fn new(bits: bool) -> Self {
        PWT_R(crate::FieldReader::new(bits))
    }
    #[doc = r"Get enumerated values variant"]
    #[inline(always)]
...
impl core::ops::Deref for PWT_R {
    type Target = crate::FieldReader<bool, PWT_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
#[doc = "Field `PWT` writer - PWT Clock Gate Control"]
pub struct PWT_W<'a> {
    w: &'a mut W,
}
impl<'a> PWT_W<'a> {
